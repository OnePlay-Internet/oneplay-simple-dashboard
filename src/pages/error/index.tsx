                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content" style={{ backgroundColor: '#212123' }}>
                        <div className="modal-body text-center p-5">
                            ...
                            <p className="font500 text-white mt-4" style={{fontSize: '20px'}}>Opps...</p>
                            <p className="font500" style={{fontSize: '16px', color: '#959595'}}>Error: Http failure response for https://client-apis.oneream.com/services/v2/start_game:403 FORBIDDEN</p>
