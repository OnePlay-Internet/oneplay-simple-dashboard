...
export default function Home() {
    return (
      <>
        <div className="container-fluid" style={{ paddingLeft: "6.0rem" }}>
                    ...
                    <div className="card border-0 transparentBg">
                      ...
                      >
                        <div className="row height45vh align-items-center">
                          <div className="col">
                            <img
                              src="https://imagic.edge-net.co/magic/rs:fit:640:480:1/dpr:1/aHR0cHM6Ly9vbmVwbGF5LWFzc2V0cy5zMy5hcC1zb3V0aC0xLmFtYXpvbmF3cy5jb20vZ2FtZV9hc3NldHMvYmIyYmM0MjRjNjRmNTM0MDg2YWE1YmJjNDc5MTgyMGZhMzA1MzhhOGI1YTYxYWRmYTU0NTdlM2E5NGJiNGE0MS9pbWFnZXMvdGV4dF9sb2dvL2hvcml6b24temVyby1kYXduLWxvZ28ucG5n.webp"
                    ...
                    <div className="card border-0 transparentBg">
                      ...
                      >
                        <div className="row height45vh align-items-center">
                          <div className="col">
                            <img
                              src="https://imagic.edge-net.co/magic/rs:fit:640:480:1/dpr:1/aHR0cHM6Ly9vbmVwbGF5LWFzc2V0cy5zMy5hcC1zb3V0aC0xLmFtYXpvbmF3cy5jb20vZ2FtZV9hc3NldHMvZDVkOTg4ZmQxMDhmOGZlYTBiZjc5OTZiMzcyNTQzZDE5YTI5Y2RkY2ZhOTY3YTlkMTEzMThkYzVlMzRmNjAwNy9pbWFnZXMvdGV4dF9sb2dvL2JvcmRlcmxhbmRzLTMtbG9nby5wbmc.webp"
                              className="img-fluid text-logo"
                              alt="..."
                            />
                          </div>
                    ...
                    <div className="card border-0 transparentBg">
                      ...
                      >
                        <div className="row height45vh align-items-center">
                          <div className="col">
                            <img
                              src="https://imagic.edge-net.co/magic/rs:fit:640:480:1/dpr:1/aHR0cHM6Ly9vbmVwbGF5LWFzc2V0cy5zMy5hcC1zb3V0aC0xLmFtYXpvbmF3cy5jb20vZ2FtZV9hc3NldHMvNmViMDIxMDA4YjlmNDRjN2RmMzQ5ZmNmM2U1MzM3MDc0MTFhNDExMzgyZmY5NDNlMGUyMDZhYzNkMTg0ZTYyZC9pbWFnZXMvdGV4dF9sb2dvL21vc3R3YW50ZWQucG5n.webp"
                              className="img-fluid text-logo"
                              alt="..."
                            />
                          </div>
                ...
                <div className="card-img-overlay">
                  <div className="row height45vh align-items-end">
                    ...
                    <div className="col-auto width40 ps-4">
                      <button className="btn text-white gradientBtn border-0 br90 px-4 btn-lg fw600">
                        Play Now
                      </button>
                    </div>
                  </div>
            ...
            <div className="col-auto">
              <div className="row justify-content-center scrolltab">
                <div className="col-auto tabOptions">
                  <a
                    href="#"
                    className="card bgColor text-decoration-none activeBG"
                  >
                ...
                <div className="col-auto tabOptions">
                  <a
                    href="#"
                    className="card bgColor text-decoration-none mutedColor"
                  >
